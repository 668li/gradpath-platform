  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-ink-500 mt-1">选择数据源类型，系统会自动识别格式并解析</p>
      </div>
      ...
      <div className="card space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-medium text-ink-500 mb-1">年份</label>
            <Input
              type="number"
              value={year}
        ...
        {mode === "url" && (
          <div>
            <label className="block text-xs font-medium text-ink-500 mb-1">报告 URL</label>
            <Input
              value={url}
        ...
        {mode === "file" && (
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-ink-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100"
            />
            {file && (
        ...
        {mode === "api" && (
          <div>
            <label className="block text-xs font-medium text-ink-500 mb-1">数据源</label>
            <Select
              value={apiSourceId}
