...
const DECISION_TEMPLATES: DecisionTemplate[] = [
  ...
  },
  {
    ...
    review_date: "",
    reasoning:
      "求稳优先。老家（中部某省）省考有对口岗位，专业（公共管理类）匹配度高；相比互联网更看重长期确定性、户籍与家庭 proximity。也考虑过选调，但竞争更卷且限制党员/学生干部，先以省考为主。",
    prediction: "若行测稳定在 70+ 申论 65+ 总分进面，面试中等发挥即可上岸；入职后工作生活平衡较好，起薪 8-10w/年但隐性福利与稳定性强。",
    assumptions: [
      "能接受薪资涨幅有限（5 年内难破 15w）",
      "笔试准备周期 6 个月，每天有效学习 4-5 小时",
      "本省户籍、专业符合报考要求，可报岗不少于 3 个",
      "能接受可能被调剂到基层岗位 2-3 年",
    ],
    details: { region: "中部某省（省会及地级市岗）", position: "综合管理类 / 乡镇机关" },
    confidence: 4,
    ai_analysis: null,
    actual_outcome: null,
    review_notes: null,
