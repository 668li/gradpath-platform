...
| 暗知识 | 38 | 真实经验贴提取（带来源 tag） | 已下线（2026-09-14 随产品瘦身下线） |
...
| 5 | **微信公众号多源路由 + 知乎/微博路由** | B站/公众号自爬资讯流 | ✅ **已落地**（知乎日报 15 + 想法热榜 15 入库 PENDING；微博 503 visitor cookie 冷却期、微信 ershcimi/wechat2rss 上游失效，如实降级暂缓） |
...
4. ~~**知乎/微博资讯流路由**~~ ✅ **已完成**（zhihu/daily 日报 + zhihu/pin/hotlist 想法热榜接入 RSSHub 白名单，30 条 PENDING 待审核；微博/微信通道失效暂缓，待上游恢复或换稳定源）
