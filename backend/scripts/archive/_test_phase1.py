...
req = urllib.request.Request(
    f"{BASE}/api/events", data=events_body.encode(), headers=H, method="POST"
)
...
# 测试feedback端点
fb_body = json.dumps(
    {"category": "卡顿", "content": "测试反馈", "page": "/dashboard", "session_id": "test-sess-001"}
)
req2 = urllib.request.Request(
    f"{BASE}/api/feedback", data=fb_body.encode(), headers=H, method="POST"
)
