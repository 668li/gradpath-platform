...
async def main():
    async with async_playwright() as p:
        ...
        await page.screenshot(
            path="D:/职业规划/职业规划/backend/app/crawlers/real_data/debug_zhipin.png",
            full_page=True,
        )
        html1 = await page.content()
        with open(
            "D:/职业规划/职业规划/backend/app/crawlers/real_data/debug_zhipin.html",
            "w",
            encoding="utf-8",
        ) as f:
            f.write(html1)
        ...
        await page.wait_for_timeout(5000)
        await page.screenshot(
            path="D:/职业规划/职业规划/backend/app/crawlers/real_data/debug_liepin.png",
            full_page=True,
        )
        html2 = await page.content()
        with open(
            "D:/职业规划/职业规划/backend/app/crawlers/real_data/debug_liepin.html",
            "w",
            encoding="utf-8",
        ) as f:
            f.write(html2)
