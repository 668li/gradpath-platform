...
async def main():
    ...
    async def handler(context: HttpCrawlingContext):
        ...
        try:
            ...
            print(f"[ERR] {url}: {e}")
            results.append(
                {"url": url, "title": "", "content": "", "content_len": 0, "error": str(e)}
            )

    uuids = [
        "eaff65cc5ef54fd985cb4124e553313e",
        "b98c4545c6c04894acaa4b387e10163f",
        "9136ab9b59de43028cc7e9a40c1add86",
        "597c8eae321d4ed58f44bc67cd709db6",
        "155389d37de04a9ba1853c20c4ca96cb",
        "83657fa4c9324e15a42146d96dd908ae",
        "6bcfa318d1c740dcbd629439ea08dcce",
        "c8475e93c19c42de8b35d6ee8773ab56",
        "4dad4702ad234d678469c36e9fd4fa4b",
        "ce00bd687e2347beabbf66f9ce4ea3b3",
        "913cae862d4a4643994bdd6511c00abe",
        "6d76e2b9167d47b68e93906f04a2af93",
    ]
