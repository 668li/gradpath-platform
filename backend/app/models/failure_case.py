...
class FailureCase(UUIDMixin, TimestampMixin, Base):
    ...
    author_role: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # 在校生/毕业生/工作3年内 等
    path_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # kaoyan/civil_service/employment/study_abroad
    stage: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # preparation/interview/final_year1/year2_plus
