...
HOLLAND_DESCRIPTIONS = {
    "R": {
        "name": "实际型",
        "desc": "喜欢动手操作，注重实践和具体成果",
        "directions": ["后端开发", "运维工程师", "嵌入式开发", "硬件工程师"],
    },
    "I": {
        "name": "研究型",
        "desc": "善于分析推理，喜欢探索和解决复杂问题",
        "directions": ["算法工程师", "数据科学家", "科研人员", "安全研究"],
    },
    "A": {
        "name": "艺术型",
        "desc": "富有创造力，追求自由表达和审美",
        "directions": ["前端开发", "UI/UX设计", "产品经理", "创意设计"],
    },
    "S": {
        "name": "社会型",
        "desc": "乐于助人，善于沟通和协调人际关系",
        "directions": ["产品经理", "项目管理", "技术顾问", "教育培训"],
    },
    "E": {
        "name": "企业型",
        "desc": "具有领导力，善于说服和推动团队达成目标",
        "directions": ["产品经理", "创业", "项目管理", "商业分析"],
    },
    "C": {
        "name": "常规型",
        "desc": "做事有条理，注重细节和规则",
        "directions": ["测试工程师", "数据分析师", "财务技术", "运维自动化"],
    },
}
