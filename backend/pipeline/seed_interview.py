        ...
        "reports": [
            {
                ...
                "dimensions": ["algorithm", "system_design", "project_depth"],
                "difficulty": 4,
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["algorithm", "project_depth", "communication"],
                "difficulty": 3,
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["project_depth", "communication", "behavior"],
                "difficulty": 3,
    ...
    # ---- 用户2: 字节跳动 (4条) ----
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["algorithm", "project_depth", "domain"],
                "difficulty": 4,
                "summary": "客户端性能优化问得多",
            },
            {
            ...
            },
            {
                ...
                "dimensions": ["algorithm", "domain", "project_depth"],
                "difficulty": 4,
        ...
        "reports": [
            {
                ...
                "rounds": 4,
                "result": InterviewResult.offer,
                "dimensions": ["system_design", "project_depth", "culture_fit"],
                "difficulty": 4,
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.rejected,
                "dimensions": ["project_depth", "communication"],
                "difficulty": 3,
                "summary": "业务案例不够深入",
            },
            {
        ...
        "reports": [
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["domain", "project_depth", "culture_fit"],
                "difficulty": 3,
        ...
        "reports": [
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["domain", "communication", "behavior"],
                "difficulty": 4,
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.rejected,
                "dimensions": ["domain", "communication"],
                "difficulty": 4,
                "summary": "行业研究深度不够",
            },
            {
                ...
                "rounds": 2,
                "result": InterviewResult.offer,
                "dimensions": ["domain", "behavior", "communication"],
                "difficulty": 3,
        ...
        "reports": [
            {
                ...
                "rounds": 4,
                "result": InterviewResult.offer,
                "dimensions": ["algorithm", "system_design", "domain"],
                "difficulty": 4,
    ...
    # ---- 用户8: 比亚迪 (3条) ----
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["domain", "project_depth"],
                "difficulty": 3,
                "summary": "硬件基础+电路设计",
            },
        ],
    ...
    # ---- 用户9: 大疆 (4条) ----
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "rounds": 3,
                "result": InterviewResult.offer,
                "dimensions": ["domain", "project_depth", "algorithm"],
                "difficulty": 4,
                "summary": "C++底层+RTOS",
            },
            {
...
def run_seed():
    ...
    try:
        # ---- 清理旧种子数据 ----
        seed_users = db.query(User).filter(User.email.like("interview_seed_%@test.com")).all()
        for user in seed_users:
            db.query(InterviewReport).filter(InterviewReport.user_id == user.id).delete()
            db.delete(user)
        db.commit()
        ...
        user_count = db.query(User).filter(User.email.like("interview_seed_%@test.com")).count()
        report_count = db.query(InterviewReport).count()
        company_count = db.query(func.count(func.distinct(InterviewReport.company))).scalar() or 0
        position_count = db.query(func.count(func.distinct(InterviewReport.position))).scalar() or 0
        print(
