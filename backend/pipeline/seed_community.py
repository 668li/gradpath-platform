    ...
    # ---- 用户1: 清华大学 (4条, 年份 2021-2024) ----
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "degree": Degree.bachelor,
                "destination_type": DestinationType.further_study,
                "employer": None,
                "city": None,
                "industry": None,
                "salary_range": None,
    ...
    # ---- 用户2: 北京大学 (5条, 年份 2020-2024) ----
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "graduation_year": 2022,
                "degree": Degree.bachelor,
                "destination_type": DestinationType.civil_service,
                "employer": "最高人民法院",
                "city": "北京",
                "industry": "法律",
                "salary_range": SalaryRange.r15k_25k,
            },
            {
                ...
                "graduation_year": 2021,
                "degree": Degree.master,
                "destination_type": DestinationType.abroad,
                "employer": "Google",
                "city": None,
                "industry": None,
                "salary_range": None,
...
def run_seed():
    ...
    try:
        # ---- 清理旧种子数据 ----
        seed_users = db.query(User).filter(User.email.like("community_seed_%@test.com")).all()
        ...
        user_count = db.query(User).filter(User.email.like("community_seed_%@test.com")).count()
        report_count = db.query(CommunityReport).count()
        school_count = (
            db.query(func.count(func.distinct(CommunityReport.school_name))).scalar() or 0
        )
